      ...
      <div className="container">
        ...
        <div className="tile is-ancestor">
          <div className="tile is-parent is-vertical is-6">
            <div className="tile is-child">
              ...
              <p>
                Parents and children learn together to increase children's
                comfort in the water and build a foundation of basic aquatic and
                water safety skills. This level is conveniently scheduled in the
                evening to ensure maximum parent participation. Ages 6 months to
                about 3 years.
              </p>
            </div>
            <div className="tile is-child">
            ...
            <div className="tile is-child">
              ...
              <p>
                Introductory level to various entrance and exit, floating,
                gliding and combined arm and leg action skills, open-eyed object
                retrieval and fun games to help your child become comfortable in
                the water. Approximately 6 years of age.
              </p>
            </div>
            <div className="tile is-child">
              <h3>Level 2: Fundamental Aquatic Skills</h3>
              <p>
                Basic swimming skills and introduction to new skills, yet still
                a fun level to learn comfort in the water and experiment with
                floats and combined arm and leg action. Approximately 7-8 years.
              </p>
            </div>
            <div className="tile is-child">
              <h3>Level 3: Stroke Development</h3>
              <p>
                Developmental level that begins to curve swimming habits into
                more aggressive, technique aquiring swimmers. New types of
                kicks, tread performance, and strokes are introduced in this
                level. Approximately 8-9 years.
              </p>
            </div>
          </div>
          <div className="tile is-parent is-vertical is-6">
            ...
            <div className="tile is-child">
              ...
              <p>
                Strenuous class that requires daily practice and critique in
                order to gain the most accurate stroke performance. Several dive
            ...
            <div className="tile is-child">
              ...
              <p>
                By this level, strudents should feel comfortable with all
                strokes turns, dives, and techniques. Lap swimming utilizing
                each stroke and performing specific techniques will allow
                students to swim with ease. Approximately 11 year and up.
              </p>
            </div>
            <div className="tile is-child">
            ...
            <div className="tile is-child">
              ...
              <p>
                ...
                specific head first entries. Stroke performance is also
                important in this level. Approximately 11 years and up.
              </p>
            </div>
            <div className="tile is-child" />
          </div>
        ...
        >
          ...
          <ul>
            ...
            <li>
              Parents need to remain outside the pool fence at all times. This
              is to prevent distractions for participants and instructors
            </li>
            <li>
